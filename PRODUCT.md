...
DesignForge is for local developers and product designers who want a focused desktop workspace for generating, previewing, and iterating React/Tailwind UI screens with Codex CLI.
...
Avoid generic SaaS dashboards, decorative AI gradients, oversized marketing heroes, and unclear boundaries between generated UI and app shell code.
...
Use semantic controls, visible focus states, readable contrast, and reduced-motion-safe transitions. Target WCAG AA for the desktop UI.
